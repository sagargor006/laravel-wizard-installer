...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('img/app/icon.png') }}">
    ...
    <style>
        ...
        .layout {
            background-image: url("{{ url('img/app/background.jpg') }}");
                    ...
                    <div class="card-body">
                        <div class="p-15">
                            <div class="m-b-30 text-center">
                                <img alt="App logo" class="img-fluid inline-block" src="{{ url('img/app/icon.png') }}" style="max-height: 45px;">
